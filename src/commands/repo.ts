...
//          spinner.stop();
//          log.error(
//             'your stored token has become invalid, try adding a new one',
//          );
//          log.hint('to add a token you can run the below command:', 'add-token');
//          process.exit(1);
//       } catch (error) {
...
//                const {
//                   initialCommit,
//                } = await inquirer.askToCreateInitialCommit();
//                if (initialCommit) {
//                   const {
//                      initialCommitMessage,
//                   } = await inquirer.askInitialCommitMessage();
